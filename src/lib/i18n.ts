...
const copy = {
  en: {
    ...
    pipeline: { eyebrow: "Project notes", title: "Understand how Lumière works.", body: "Architecture notes explain how the language is organized, how code runs, and what is still evolving during alpha." },
  ...
  fr: {
    ...
    pipeline: { eyebrow: "Notes du projet", title: "Comprendre le fonctionnement de Lumière.", body: "Les notes d’architecture expliquent l’organisation du langage, l’exécution du code et les zones encore en évolution pendant l’alpha." },
